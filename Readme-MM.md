...
### Subtitle editing
- **`\N` ကို `\N`လို့မဟုတ်ပဲ အကြောင်းအသစ်ဖြစ်အောင်လုပ်ထားတယ်(tag ထဲမှာလဲရတယ်နော်)
...
သုံးချင်တဲ့သူတွေစိတ်ဝင်စားရင်ကိုယ့် script **[Irodori](https://github.com/amanosatosi/irodori)** ကိုပါတစ်ချက်ကြည့်လိုက်ပါဦး
